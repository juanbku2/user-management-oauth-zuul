...
import com.clinica.oauth2.clinicaoauth2.props.SecurityProperties;
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                .withClient("clientId").secret("{bcrypt}$2a$10$vCXMWCn7fDZWOcLnIEhmK.74dvK1Eh8ae2WrWlhr2ETPLoxQctN4.")
                ...
                .autoApprove(true)
                .accessTokenValiditySeconds(60 * 60 * 8)//Access token is only valid for 3 minutes.
